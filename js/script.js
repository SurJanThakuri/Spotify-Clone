...
async function displayAlbums() {
    let a = await fetch(`https://surjanthakuri.github.io/Spotify-Clone/songs/`)
    let response = await a.text();
    let div = document.createElement("div")
    div.innerHTML = response;
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs")) {
            ...
            let a = await fetch(`https://surjanthakuri.github.io/Spotify-Clone/songs/${folder}/info.json`)
            ...
            <img src="https://surjanthakuri.github.io/Spotify-Clone/songs/${folder}/cover.jpeg"
                alt="">
...
async function main() {
    ...
    await getSongs("https://surjanthakuri.github.io/Spotify-Clone/songs/first")
